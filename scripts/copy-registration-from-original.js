...
const registrationHtmlPath = path.join(PUBLIC, 'registration', 'index.html');
const ORIGINAL_URL = 'https://888starz-africa.com/registration/';
...
async function copyFullPageFromOriginal() {
    ...
    try {
        ...
        const registrationDir = path.dirname(registrationHtmlPath);
        fs.mkdirSync(registrationDir, { recursive: true });
        
        // Сохраняем полный HTML
        fs.writeFileSync(registrationHtmlPath, html, 'utf8');
        console.log(`✓ Полный HTML сохранен: ${registrationHtmlPath}`);
