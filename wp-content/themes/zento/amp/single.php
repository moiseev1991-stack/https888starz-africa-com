                    ...
                    <article <?php post_class('main-article bg-box section '.$post_class); ?>>
                        ...
                        <section class="post-content">
                            ...
                            <?php if( comments_open() ): ?>
                                <div id="go-to-comments" class="go-to-comments section np-bottom textcenter">
                                    <a href="<?php the_permalink(); ?>#comments" rel="noamphtml" class="epcl-button large"><?php esc_html_e('Leave a Comment', 'zento'); ?></a>
                                </div>
                            <?php endif; ?>
