...
function prefix_merlin_local_import_files() {
	return array(
        array(
			'import_file_name'             => 'Tutorials Demo',
			...
			// 'import_preview_image_url'     => 'https://ghost.estudiopatagon.com/zento/content/images/size/w1024h1024/2024/02/about.webp',
			'import_notice'                => 'Before install Demo config, it is recommended to install our required plugin ('.EPCL_THEMENAME.' Functions)',            
			'preview_url'                  => 'https://themes.estudiopatagon.com/wordpress/zento',
		),
        array(
			'import_file_name'             => 'Personal Demo',
			'local_import_file'            => trailingslashit( get_template_directory() ) . 'functions/import/personal-demo-content.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'functions/import/personal-widgets.wie',
            'local_import_csf'           => array(
                array(
                    'file_path'   => trailingslashit( get_template_directory() ) . 'functions/import/personal-csf-options.json',
                    'option_name' => 'epcl_theme',
                ),
            ),
			// 'import_preview_image_url'     => 'https://ghost.estudiopatagon.com/zento/content/images/size/w1024h1024/2024/02/about.webp',
			'import_notice'                => 'Before install Demo config, it is recommended to install our required plugin ('.EPCL_THEMENAME.' Functions)',              
			'preview_url'                  => 'https://themes.estudiopatagon.com/wordpress/zento-personal',
		),
	);
}
