<?php
/**
 * Plugin Name: Zento Theme Functions
 * Plugin URI: https://estudiopatagon.com
 * Description: This plugin enables core functions for <a href="https://estudiopatagon.com/projects/zento-for-wordpress">Zento - Modern & Lightweight Theme for WordPress</a> by <a href="https://estudiopatagon.com">EstudioPatagon</a>.
 * Version: 1.4.5
...
/* Check if Zento Theme is activated */

if( get_template() != 'zento' ){
    return;
}

if ( !class_exists('epcl_zento_theme_functions') ) {
    ...
    if( !defined('EPCL_THEMESLUG') ) define('EPCL_THEMESLUG', 'zento'); // Do not change
    if( !defined('EPCL_ITEM_ID') ) define('EPCL_ITEM_ID', '51579969'); // Do no change

    class epcl_zento_theme_functions {
        ...
        public function __construct() {
            ...
            add_filter('manage_edit-post_sortable_columns', array( $this, 'custom_column_register_sortable'), 5, 2);
		...
		public function posts_columns($defaults){
            $defaults[EPCL_THEMEPREFIX.'_post_image'] = esc_html__('Image', 'zento');
            $defaults[EPCL_THEMEPREFIX.'_post_order'] = esc_html__('Order', 'zento');
			return $defaults;
		}
		...
		public function posts_custom_columns($column_name, $id){
            ...
            if( $column_name === EPCL_THEMEPREFIX.'_post_order' ){
                $post = get_post($id);
        ...
        function custom_column_register_sortable($columns) {
            $columns[EPCL_THEMEPREFIX.'_post_order'] = 'menu_order';
            return $columns;
        }    
	 ...
	 new epcl_zento_theme_functions();
