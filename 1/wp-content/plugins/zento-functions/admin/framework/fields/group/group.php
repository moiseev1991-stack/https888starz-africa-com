    ...
    public function render() {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="csf-cloneable-item csf-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          echo '<i class="csf-cloneable-sort fas fa-arrows-alt" title="Drag & drop to move this module"></i>';
          echo '<i class="csf-cloneable-clone far fa-clone" title="Drag & drop to move this module"></i>';
        ...
        if ( ! empty( $this->value ) ) {
          ...
          foreach ( $this->value as $value ) {
            ...
            echo '<div class="csf-cloneable-item">';
              ...
              echo '<div class="csf-cloneable-helper">';
              echo '<i class="csf-cloneable-sort fas fa-arrows" title="Drag & drop to move this Block"></i>';
              echo '<i class="csf-cloneable-clone far fa-clone" title="Clone this Block"></i>';
              echo '<i class="csf-cloneable-remove csf-confirm fas fa-times" title="Remove this Block" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'csf' ) .'"></i>';
              echo '</div>';
