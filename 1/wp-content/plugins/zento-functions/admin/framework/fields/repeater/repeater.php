  ...
  class CSF_Field_repeater extends CSF_Fields {
    ...
    public function render() {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<i class="csf-repeater-sort fas fa-arrows" title="Drag & drop to move this Block"></i>';
        echo '<i class="csf-repeater-clone far fa-clone" title="Clone this Block"></i>';
        echo '<i class="csf-repeater-remove csf-confirm fas fa-times" title="Remove this Block" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'csf' ) .'"></i>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
