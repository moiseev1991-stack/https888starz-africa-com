...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
            ...
            'subtitle' => esc_html__('Urbanist and DM Sans', 'epcl_framework'),
        ...
        array(
            ...
            'subtitle' => esc_html__('Default: DM Sans (Google font)', 'epcl_framework'),		
        ...
        array(
			...
			'subtitle' => esc_html__('Default: Urbanist (Google font)', 'epcl_framework'),
