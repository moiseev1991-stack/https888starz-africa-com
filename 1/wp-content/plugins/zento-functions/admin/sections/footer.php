...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        array(
			...
			'type' => 'switcher',
			'title' => esc_html__('Enable Call to Action on Footer', 'epcl_framework'),
			'desc' => esc_html__('This will display the "Join to our community" section.', 'epcl_framework'),
			'default' => '1'
        ),
        array(
			'id' => 'enable_footer_decorations',
			'type' => 'switcher',
			'title' => esc_html__('Enable CTA decorations', 'epcl_framework'),
			'desc' => esc_html__('This will display some decorations at the edges of the container.', 'epcl_framework'),
			'default' => '1',
            'dependency' => array( 'enable_footer_cta',   '==', '1' ),
        ),
        array(
			'id' => 'footer_cta_text_left',
			'type' => 'wp_editor',
			'title' => esc_html__('CTA Left Content', 'epcl_framework'),
        ...
        array(
			'id' => 'footer_cta_text_right',
			'type' => 'wp_editor',
			'title' => esc_html__('CTA Right Content', 'epcl_framework'),
			'subtitle' => esc_html__('HTML and Shortcodes are allowed', 'epcl_framework'),
            'desc' => '',
            'media_buttons' => true,
            'dependency' => array( 'enable_footer_cta',   '==', '1' ),
