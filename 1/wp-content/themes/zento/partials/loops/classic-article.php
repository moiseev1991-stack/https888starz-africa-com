...
<article <?php post_class('default classic-large bg-box epcl-flex index-'.$index.' '.$post_class); ?>>
    ...
    <div class="meta meta-data">
        ...
        <span class="hide-on-mobile"><?php get_template_part('partials/meta-info/views-counter'); ?></span>
        ...
        <?php if( empty($epcl_theme) || $epcl_theme['classic_display_excerpt'] !== '0' ): ?>
            <div class="post-excerpt">                    
                ...
                <?php if( !get_the_title() ): ?>
                    <a href="<?php the_permalink(); ?>" class="continue-reading"><?php the_excerpt(); ?></a>
                <?php else: ?>
                    <?php the_excerpt(); ?>      
                <?php endif; ?>        
            </div>  
